...
const FIELD_KEYS = [
  ...
  'por_que_adoptar', 'genero_preferido', 'edad_estimada_gatito', 'responsable_gastos', 'cuidador_principal',
  ...
  'donacion_tipo', 'donacion_monto',
  'compromisos_aceptados', 'declaracion_final',
] as const;

const INT_FIELDS = new Set([
  'edad', 'estrato', 'mallas_seguridad', 'tiene_otras_mascotas', 'otras_esterilizadas',
  'adultos_casa', 'todos_de_acuerdo', 'planes_mudanza', 'alguien_alergico',
  'donacion_monto', 'declaracion_final',
]);
